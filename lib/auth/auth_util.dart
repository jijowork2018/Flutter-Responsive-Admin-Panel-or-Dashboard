...
bool get currentUserIsAdmin =>
    currentUserDocument?.isAdmin ?? currentUserDocument?.isAdmin ?? false;

DocumentReference get currentUserClient => currentUserDocument?.client;

DocumentReference get currentUserTrainer => currentUserDocument?.trainer;
